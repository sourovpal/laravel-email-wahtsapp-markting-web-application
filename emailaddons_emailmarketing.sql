...
--
-- Host: localhost:3306
-- Generation Time: Aug 18, 2023 at 03:07 PM
...
--
-- Database: `emailaddons_emailmarketing`
--
...
CREATE TABLE `admins` (
  ...
  `api_key` varchar(299) DEFAULT NULL,
...
CREATE TABLE `android_api_sim_infos` (
  ...
  `sim_number` varchar(90) DEFAULT NULL,
...
INSERT INTO `email_groups` (`id`, `user_id`, `name`, `status`, `created_at`, `updated_at`) VALUES
(1, NULL, 'Johan D', 1, '2023-08-18 19:24:37', '2023-08-18 19:24:37');
...
CREATE TABLE `email_logs` (
  ...
  `response_gateway` varchar(299) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `email_logs` (`id`, `uid`, `sender_id`, `user_id`, `from_name`, `reply_to_email`, `to`, `initiated_time`, `message`, `subject`, `status`, `schedule_status`, `response_gateway`, `created_at`, `updated_at`) VALUES
(1, '1c93a2d2-067d-4909-b98f-90e95afb', 2, NULL, 'RFQ', 'Servicew2000@gmail.com', 'servicew38@gmail.com', '2023-08-18 16:21:32', '<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\" \"http://www.w3.org/TR/REC-html40/loose.dtd\">\n<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"></head><body><p>test</p></body></html>\n', 'test', 4, 1, NULL, '2023-08-18 19:21:32', '2023-08-18 19:21:32'),
(2, '1fd7ae69-7de8-4346-b24a-315a36e1', 2, NULL, 'RFQ', 'Servicew2000@gmail.com', 'servicew38@gmail.com', '2023-08-18 16:27:36', '<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\" \"http://www.w3.org/TR/REC-html40/loose.dtd\">\n<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"></head><body><p>rgfffffffffffffffffffffffffffffffffffff</p></body></html>\n', 'test', 4, 1, NULL, '2023-08-18 19:27:36', '2023-08-18 19:27:37');
...
CREATE TABLE `general_settings` (
  ...
  `copyright` varchar(299) DEFAULT NULL,
  ...
  `social_login` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `frontend_section` text DEFAULT NULL,
  ...
  `debug_mode` enum('true','false') NOT NULL DEFAULT 'false',
  `maintenance_mode` enum('true','false') NOT NULL DEFAULT 'false',
  `maintenance_mode_message` varchar(500) DEFAULT NULL,
...
(1, 'SMTP', 1, '{\"driver\":\"SMTP\",\"host\":\"smtp.office365.com\",\"smtp_port\":\"587\",\"from\":{\"address\":\"jtrianav@est.cristobalcolon.edu.ec\",\"name\":\"RFQ\"},\"encryption\":\"TLS\",\"username\":\"jtrianav@est.cristobalcolon.edu.ec\",\"password\":\"Melseband5\"}', '2022-09-09 14:52:30', '2023-08-18 19:14:13'),
...
(1, 'Servicew38@gmail.com', '2066589', '2023-08-18 19:40:39');
...
CREATE TABLE `payment_methods` (
  ...
  `payment_parameter` text NOT NULL,
...
CREATE TABLE `subscriptions` (
  ...
  `trx_number` varchar(30) DEFAULT NULL,
...
CREATE TABLE `s_m_slogs` (
  ...
  `schedule_status` tinyint(4) DEFAULT 1 COMMENT 'Send Now : 1, Send Later : 2',
  `response_gateway` varchar(259) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `transactions` (
  ...
  `transaction_number` varchar(70) DEFAULT NULL,
  `details` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `whatsapp_credit` varchar(299) NOT NULL DEFAULT '0',
  `sms_gateway` tinyint(20) DEFAULT 1 COMMENT 'Api Gateway : 1, Android Gateway : 2 ',
  `address` text DEFAULT NULL,
  `image` varchar(191) DEFAULT NULL,
  `password` varchar(255) DEFAULT NULL,
  `api_key` varchar(299) DEFAULT NULL,
  `gateways_api_credentials` text DEFAULT NULL,
  `status` tinyint(4) DEFAULT 1 COMMENT 'Active : 1, Banned : 0',
  `gateways_credentials` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `name`, `email`, `google_id`, `credit`, `email_credit`, `whatsapp_credit`, `sms_gateway`, `address`, `image`, `password`, `api_key`, `gateways_api_credentials`, `status`, `gateways_credentials`, `created_at`, `updated_at`) VALUES
(1, 'Williams James', 'Servicew38@gmail.com', NULL, 0, 0, '0', 1, NULL, NULL, '$2y$10$KpinD/qcZ9999.UzjO3c8eaqXulk6Ji9EoGYlljtOFsHqYeqB5OWK', NULL, NULL, 3, '{\"sms\":{\"default_gateway_id\":1,\"101NEX\":{\"api_key\":\"####\",\"api_secret\":\"####\",\"sender_id\":1},\"102TWI\":{\"account_sid\":\"####\",\"auth_token\":\"####\",\"from_number\":\"####\",\"sender_id\":\"####\"},\"103BIRD\":{\"access_key\":\"####\",\"sender_id\":\"####\"},\"104MAG\":{\"api_key\":\"####\",\"text_magic_username\":\"#####\",\"sender_id\":\"####\"},\"105CLICKATELL\":{\"clickatell_api_key\":\"####\",\"sender_id\":\"####\"},\"106INFOBIP\":{\"infobip_base_url\":\"####\",\"infobip_api_key\":\"####\",\"sender_id\":\"####\"},\"107SMSBROADCAST\":{\"sms_broadcast_username\":\"####\",\"sms_broadcast_password\":\"####\"}},\"email\":{\"default_gateway_id\":1,\"SMTP\":{\"driver\":\"SMTP\",\"host\":\"smtp.mailtrap.io\",\"port\":\"2525\",\"encryption\":\"tls\",\"username\":null,\"password\":null,\"from_address\":null,\"from_name\":null},\"send_grid_api\":{\"app_key\":\"####\",\"from_address\":\"demo@gmail.com\",\"from_name\":\"Demo User\"}}}', '2023-08-18 19:40:39', '2023-08-18 19:40:39'),
(2, 'Williams James', 'Servicew2000@gmail.com', NULL, 5, 20, '40', 1, NULL, NULL, '$2y$10$d.AOL8P.2hWxN/qeg0QhKu1wcEXbpPWLha2HVOyN/YTpECoOj/Day', NULL, NULL, 1, '{\"email\":{\"SMTP\":{\"driver\":\"SMTP\",\"host\":\"smtp.mailtrap.io\",\"port\":\"2525\",\"encryption\":\"tls\",\"username\":\"\",\"password\":\"\",\"from_address\":\"\",\"from_name\":\"\"}}}', '2023-08-18 19:42:56', '2023-08-19 02:59:55');
...
CREATE TABLE `wa_device` (
  ...
  `number` varchar(259) NOT NULL,
  `name` varchar(259) NOT NULL,
  `wp_session_id` varchar(299) DEFAULT NULL,
  `delay_time` varchar(259) DEFAULT NULL,
  `status` enum('connected','disconnected','initiate') NOT NULL,
  `multidevice` enum('YES','NO') NOT NULL DEFAULT 'YES',
...
CREATE TABLE `whatsapp_logs` (
  ...
  `image` varchar(255) DEFAULT NULL,
  `video` varchar(299) DEFAULT NULL,
  `status` tinyint(4) DEFAULT 0 COMMENT 'Pending : 1, Schedule : 2 Fail : 3 Success: 4',
  `schedule_status` tinyint(4) DEFAULT 1 COMMENT 'Send Now : 1, Send Later : 2',
  `response_gateway` varchar(259) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
