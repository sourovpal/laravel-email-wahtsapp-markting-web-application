                            ...
                            <div class="col-12 col-md-8 col-lg-8 col-xl-7">
                                <div class="row justify-content-end">
                                    <div class="col-12 col-lg-6 col-xl-6 px-2 py-1 ">
                                        <form action="{{route('user.sms.default.gateway')}}" method="POST" class="form-inline float-sm-right text-end">
                                            @csrf
                                ...
                                @forelse($smsGateways as $smsGateway)
                                    <tr class="@if($loop->even) table-light @endif">
                                        ...
                                        <td data-label={{ translate('Action')}}>
                                            <a href="{{route('user.gateway.sms.edit', $smsGateway->id)}}" class="btn--primary text--light brand" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="las la-pen"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
