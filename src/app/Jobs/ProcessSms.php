...
class ProcessSms implements ShouldQueue
{
    ...
    public function handle()
    {
        if($this->gatewayCode == "101NEX"){
            return SendSMS::nexmo($this->to,$this->datacoding,$this->message,$this->credential,$this->smsId);
        }
        elseif($this->gatewayCode == "102TWI"){
            SendSMS::twilio($this->to,$this->datacoding,$this->message,$this->credential,$this->smsId);
        }
        ...
        elseif($this->gatewayCode == "104MAG"){
            SendSMS::textMagic($this->to,$this->datacoding,$this->message,$this->credential,$this->smsId);
        }
        elseif($this->gatewayCode == "105CLICKATELL"){
            SendSMS::clickaTell($this->to,$this->datacoding,$this->message,$this->credential,$this->smsId);
        }
        elseif($this->gatewayCode == "106INFOBIP"){
            SendSMS::infoBip($this->to,$this->datacoding,$this->message,$this->credential,$this->smsId);
        }
        elseif($this->gatewayCode == "107SMSBROADCAST"){
            SendSMS::smsBroadcast($this->to,$this->datacoding,$this->message,$this->credential,$this->smsId);
        }
        elseif($this->gatewayCode == "108MIMSMS"){
            SendSMS::mimSMS($this->to,$this->datacoding,$this->message,$this->credential,$this->smsId);
        }
        elseif($this->gatewayCode == "109AJURA"){
            SendSMS::ajuraSMS($this->to,$this->datacoding,$this->message,$this->credential,$this->smsId);
        }
        elseif($this->gatewayCode == "110MSG91"){
            SendSMS::msg91($this->to,$this->datacoding,$this->message,$this->credential,$this->smsId);
        }
    }
